...
export default class PostUseCase {
    ...
    public async create(userId:string, readTimeType:PostReadTimeType | null,readTime:number | null, title:string,status:PostStatus,body:Object[],request:any): Promise<void> {
        /**
         * body: [
         *    {
         *       innerObj : "njcshc"
         ...
         * ]
         */
        const {contents,publicIds} = await this.formatPostInputBody(body, request);
    ...
    private async formatPostInputBody(body:Object[],request:any):Promise<{contents:Object[], publicIds:string[]}> {
        let contents : Object[] = []
