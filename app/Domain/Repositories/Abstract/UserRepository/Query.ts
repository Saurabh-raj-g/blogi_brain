...
import { Query as DatasourceQuery } from "App/Data/Datasources/Abstract/UserDatasource/Query";
...
export class Query {
    ...
    public toDatasourceQuery(): DatasourceQuery {
        ...
        query.fullNames = this.fullNames;
        query.notFullNames = this.notFullNames;
        query.verified = this.verified;
        query.title = this.title;
        query.titles = this.titles;
        query.notTitles = this.notTitles;
        query.role = this.role;
        query.roles = this.roles;
        query.notRoles = this.notRoles;
        query.username = this.username;
        query.usernames = this.usernames;
        query.notUsernames = this.notUsernames;
        query.email = this.email;
        query.emails = this.emails;
        query.notEmails = this.notEmails;
        query.minLastAccessedAt = this.minLastAccessedAt;
        query.maxLastAccessedAt = this.maxLastAccessedAt;
