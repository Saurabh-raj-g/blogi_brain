...
export default class UserRepositoryImpl implements UserRepository {
    ...
    async findByUsernameOrEmail(
        ...
        const userByEmail = await this.userDatasource.findByEmail(
            usernameOrEmail
        );
        if (userByEmail === null) {
            const userByUsername = await this.userDatasource.findByUsername(
                usernameOrEmail
            );
            ...
            const userByUsernameEntity = UserEntity.fromJson(
                userByUsername.toJsonForEntity()
            );
        ...
        const userByEmailEntity = UserEntity.fromJson(
            userByEmail.toJsonForEntity()
        );
